    ...
    void Update(){
        if(active){
            if (timeCount<=1){
                ...
                //transform.rotation=Quaternion.Slerp(Quaternion.Euler(transform.rotation.x,transform.rotation.y,transform.rotation.z),Quaternion.Euler(transform.rotation.x,transform.rotation.y+170,transform.rotation.z+0),timeCount);
            ...
            /*if(transform.rotation==Quaternion.Euler(transform.rotation.x,transform.rotation.y+170,transform.rotation.z+0)){
                timeCount = 0.0f;
                active = false;
            }*/
        }
